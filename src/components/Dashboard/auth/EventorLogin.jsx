...
const EventorLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios
        .post("http://localhost:5000/api/v1/eventor/eventorLogin", {
          email,
          password,
        })
        .then((data) => {
    ...
    <div className="rounded-xl bg-white shadow-xl">
      <div className="px-5 py-5 flex justify-start items-center gap-5">
        ...
        <h2 className="text-2xl text-cyan-900 font-bold">
          Sign in to unlock the <br /> best of Eventor
        </h2>
      </div>
      ...
      <p className="mt-5 py-5 px-5">
        ...
        <Link to="/eventorRegister" className="text-blue-500">
          Register
        </Link>{" "}
        here
      </p>
